...
namespace EvL
{
	...
	public partial class Account : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<EvL.Account> Referencedaccount_master_account
		{
			get
			{
				return this.GetRelatedEntities<EvL.Account>("account_master_account", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.OnPropertyChanging("Referencedaccount_master_account");
				this.SetRelatedEntities<EvL.Account>("account_master_account", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public System.Collections.Generic.IEnumerable<EvL.Account> Referencedaccount_parent_account
		{
			get
			{
				return this.GetRelatedEntities<EvL.Account>("account_parent_account", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.OnPropertyChanging("Referencedaccount_parent_account");
				this.SetRelatedEntities<EvL.Account>("account_parent_account", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public EvL.Account Referencingaccount_master_account
		{
			get
			{
				return this.GetRelatedEntity<EvL.Account>("account_master_account", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
		}
		...
		public EvL.Account Referencingaccount_parent_account
		{
			get
			{
				return this.GetRelatedEntity<EvL.Account>("account_parent_account", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
			set
			{
				this.OnPropertyChanging("Referencingaccount_parent_account");
				this.SetRelatedEntity<EvL.Account>("account_parent_account", Microsoft.Xrm.Sdk.EntityRole.Referencing, value);
	...
	public partial class XrmSvc : Microsoft.Xrm.Sdk.Client.OrganizationServiceContext
	{
		...
		/// <summary>
		/// Gets a binding to the set of all <see cref="EvL.Account"/> entities.
		/// </summary>
		public System.Linq.IQueryable<EvL.Account> AccountSet
		{
			get
			{
				return this.CreateQuery<EvL.Account>();
			}
		}
	}
}
